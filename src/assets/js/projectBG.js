 ...
 * Demo.
 */
function projectBGAnimationController() {
  ...
  // https://trianglify.io/p/w:1440!h:900!x:random!v:0.005!c:0.181!s:0.12929991356809722
  /**
  ...
  function init() {
    ...
    var pattern = Trianglify({
      ...
      variance: 1,
      stroke_width: 1,
      x_colors: ['#aaa', '#eee', '#333']
      //original "Purples", surprise "random" ,['#000000', '#ccc', '#FFFFFF']
    }).svg(); // Render as SVG.
